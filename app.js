...
const utc_time = currentDate.toISOString().slice(0,-5)+"Z";/*let utc_time = currentDate.toISOString().slice(0,-5)+'Z'; */ /*const utcTime = new Date().toISOString().replace(/\.\d{3}Z$/,'Z')*/;/*doesnt work */
...
const currentUTCHours = new Date().getUTCHours(); deploy failed*/
